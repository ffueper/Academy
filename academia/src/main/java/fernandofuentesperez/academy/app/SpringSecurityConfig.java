...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/", "/css/**", "/js/**", "/images/**", "/home", "/userRegister").permitAll()
		//.antMatchers("/clientList/**").hasAnyRole("ADMIN")
		//.antMatchers("/studentList/**").hasAnyRole("ADMIN")
